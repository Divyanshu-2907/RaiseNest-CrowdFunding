...
//                 <input type="text" value={form.email?form.email: " "} onChange={handleChange} name='email' id='email' className='block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500  focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark"text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'/>
//             </div>
//             <div className="my-2">
//                 <label htmlFor="username" className='block mb-2 text-sm font-medium text-gray-900 dark:text-white'>Username</label>
//                 <input type="text" value={form.username?form.username: " "} onChange={handleChange} name='username' id='username' className='block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500  focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark"text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'/>
//             </div>
//             <div className="my-2">
//                 <label htmlFor="profile" className='block mb-2 text-sm font-medium text-gray-900 dark:text-white'>Profile Picture</label>
//                 <input type="text" value={form.profile?form.profile: " "} onChange={handleChange} name='profile' id='profile' className='block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500  focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark"text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'/>
//             </div>
//             <div className="my-2">
//                 <label htmlFor="cover" className='block mb-2 text-sm font-medium text-gray-900 dark:text-white'>Cover Picture</label>
//                 <input type="text" value={form.cover?form.cover: " "} onChange={handleChange} name='cover' id='cover' className='block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500  focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark"text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'/>
//             </div>
//             <div className="my-2">
//                 <label htmlFor="razorpayid" className='block mb-2 text-sm font-medium text-gray-900 dark:text-white'>Razorpay Id</label>
//                 <input type="text" value={form.razorpayid?form.razorpayid: " "} onChange={handleChange} name='razorpayid' id='razorpayid' className='block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500  focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark"text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'/>
//             </div>
//             <div className="my-2">
//                 <label htmlFor="razorpaysecret" className='block mb-2 text-sm font-medium text-gray-900 dark:text-white'>Razorpay Secret</label>
//                 <input type="text" value={form.razorpaysecret?form.razorpaysecret: " "} onChange={handleChange} name='razorpaysecret' id='razorpaysecret' className='block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500  focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark"text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'/>
//             </div>
//             <div className="my-6">
